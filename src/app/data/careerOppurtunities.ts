export const careerOpportunities = {
    researchAssociatePositions: [
      {
        ...
        // description: "Understanding the SEI formation in solid and liquid electrolytes",
        responsibilities: [
    ...
    phdPosition: {
      role: "PhD",
      title: "Understanding ionic and electronic transport properties of catholyte in solid-state batteries.",
      // description:
      ...
      responsibilities: [
        "One PhD position is available on understanding ionic and electronic transport properties of catholyte in a solid-state battery.",
        // "Couple electrochemical impedance spectroscopy with FIB milling-based tomography for analysis.",
